...
plt.plot(x_axis, trace1,label='Boot 10 times',linewidth=2.5, linestyle='-', color = 'gray')
plt.plot(x_axis, trace2,label='Boot 20 times',linewidth=2.5, linestyle='-',  color = 'black')
plt.plot(x_axis, trace3,label='Boot 50 times',linewidth=2.5, linestyle='-',  color = 'g')
plt.plot(x_axis, trace4,label='Boot 100 times',linewidth=2.5, linestyle='-',  color = 'slateblue')
