...
trace6 = []
#F1 = open('rr_1000traces_snr1_f5-2019-07-30_15_09/5.28109118925Rand1Noise_1000traces_1SNR_f5.txt','r')
F1 = open('tplog-step20-range500.txt','r')
file_string1 = F1.read()
F1.close()
file_split1 = file_string1.split("\n")[:-1]
#print(file_split1)
trace6 = np.array(file_split1, dtype = np.float32)
...
plt.plot(x_axis, trace1,label='Boostrap - Boot 100 times',linewidth=2.5, linestyle='-', color = 'gray')
plt.plot(x_axis, trace2,label='Boostrap - Boot 200 times',linewidth=2.5, linestyle='-',  color = 'black')
plt.plot(x_axis, trace3,label='Boostrap - Boot 300 times',linewidth=2.5, linestyle='-',  color = 'g')
plt.plot(x_axis, trace4,label='Boostrap - Boot 400 times',linewidth=2.5, linestyle='-',  color = 'y')
#plt.plot(x_axis, trace5,label='Boostrap - Boot 500 times',linewidth=2.5, linestyle='-',  color = 'orange')
plt.plot(x_axis, trace6,label='t-test',linewidth=2.5, linestyle='-',  color = 'navy')
...
plt.axhline(y=5, color='r',linewidth=2.5)
